...
function renderContent(notification) {
  ...
  if (notification.type === '주문') {
    return {
      avatar: <img alt={notification.type} src="/assets/icons/ic_notification_package.svg" />,
      title,
    };
  }
  if (notification.type === '사용자') {
    return {
      avatar: <img alt={notification.type} src="/assets/icons/ic_notification_person.jpg" />,
      title,
    };
  }
  if (notification.type === '메세지') {
    return {
      avatar: <img alt={notification.type} src="/assets/icons/ic_notification_chat.svg" />,
      title,
    };
  }
}
